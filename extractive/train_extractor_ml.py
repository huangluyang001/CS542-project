...
def main(args):
    ...
    train_batcher, val_batcher = build_batchers(args.net_type, word2id,
                                                args.cuda, args.debug, args.neusum, args.stop, args.combine)
    net, net_args = configure_net(args.net_type,
                                      len(word2id), args.emb_dim, args.conv_hidden,
                                      args.lstm_hidden, args.lstm_layer, args.bi, args.pe, args.petrainable, args.stop)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pe', action='store_true',
                        help='enable positional encoder')
    parser.add_argument('--petrainable', action='store_true',
                        help='enable positional encoder trainable')
    parser.add_argument('--neusum', action='store_true', help='neusum data construction')
    parser.add_argument('--combine', action='store_true', help='combine data construction')
    parser.add_argument('--stop', action='store_true', help='if add stop')
    # length limit
